...
pub mod staking {
    const _: () = {
        ::core::include_bytes!("abis/Staking.json",);
    };
    #[allow(deprecated)]
    ...
    impl<M> ::core::fmt::Debug for Staking<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(Staking))
                .field(&self.address())
                .finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> Staking<M> {
        ...
        pub fn admin_reset_epoch(&self) -> ::ethers::contract::builders::ContractCall<M, ()> {
            self.0
        ...
        pub fn get_max_version(&self) -> ::ethers::contract::builders::ContractCall<M, Version> {
            self.0
        ...
        pub fn get_min_version(&self) -> ::ethers::contract::builders::ContractCall<M, Version> {
            self.0
        ...
        ) -> ::ethers::contract::builders::ContractCall<M, ::std::vec::Vec<AddressMapping>>
        {
            self.0
        ...
        pub fn kick_validator_in_next_epoch(
            ...
            self.0
                .method_hash([134, 84, 25, 233], (validator_staker_address, reason, data))
                .expect("method not found (this should never happen)")
        }
        ...
        pub fn request_to_leave(&self) -> ::ethers::contract::builders::ContractCall<M, ()> {
            self.0
        ...
        pub fn clear_offline_phase_data_filter(
            &self,
        ) -> ::ethers::contract::builders::Event<::std::sync::Arc<M>, M, ClearOfflinePhaseDataFilter>
        {
            self.0.event()
        }
        ...
        pub fn complaint_config_set_filter(
            &self,
        ) -> ::ethers::contract::builders::Event<::std::sync::Arc<M>, M, ComplaintConfigSetFilter>
        {
            self.0.event()
        }
        ...
        pub fn count_offline_phase_data_filter(
            &self,
        ) -> ::ethers::contract::builders::Event<::std::sync::Arc<M>, M, CountOfflinePhaseDataFilter>
        {
            self.0.event()
        }
        ...
        pub fn devops_admin_set_filter(
            &self,
        ) -> ::ethers::contract::builders::Event<::std::sync::Arc<M>, M, DevopsAdminSetFilter>
        {
            self.0.event()
        }
        ...
        pub fn epoch_end_time_set_filter(
            &self,
        ) -> ::ethers::contract::builders::Event<::std::sync::Arc<M>, M, EpochEndTimeSetFilter>
        {
            self.0.event()
        }
        ...
        pub fn epoch_length_set_filter(
            &self,
        ) -> ::ethers::contract::builders::Event<::std::sync::Arc<M>, M, EpochLengthSetFilter>
        {
            self.0.event()
        }
        ...
        pub fn epoch_timeout_set_filter(
            &self,
        ) -> ::ethers::contract::builders::Event<::std::sync::Arc<M>, M, EpochTimeoutSetFilter>
        {
            self.0.event()
        }
        ...
        pub fn kick_penalty_percent_set_filter(
            &self,
        ) -> ::ethers::contract::builders::Event<::std::sync::Arc<M>, M, KickPenaltyPercentSetFilter>
        {
            self.0.event()
        }
        ...
        pub fn ready_for_next_epoch_filter(
            &self,
        ) -> ::ethers::contract::builders::Event<::std::sync::Arc<M>, M, ReadyForNextEpochFilter>
        {
            self.0.event()
        }
        ...
        pub fn recovered_filter(
            &self,
        ) -> ::ethers::contract::builders::Event<::std::sync::Arc<M>, M, RecoveredFilter> {
            self.0.event()
        }
        ///Gets the contract's `RequestToJoin` event
        pub fn request_to_join_filter(
            &self,
        ) -> ::ethers::contract::builders::Event<::std::sync::Arc<M>, M, RequestToJoinFilter>
        {
            self.0.event()
        }
        ...
        pub fn request_to_leave_filter(
            &self,
        ) -> ::ethers::contract::builders::Event<::std::sync::Arc<M>, M, RequestToLeaveFilter>
        {
            self.0.event()
        }
        ...
        pub fn rewards_duration_updated_filter(
            &self,
        ) -> ::ethers::contract::builders::Event<::std::sync::Arc<M>, M, RewardsDurationUpdatedFilter>
        {
            self.0.event()
        }
        ...
        pub fn staking_token_set_filter(
            &self,
        ) -> ::ethers::contract::builders::Event<::std::sync::Arc<M>, M, StakingTokenSetFilter>
        {
            self.0.event()
        }
        ...
        pub fn state_changed_filter(
            &self,
        ) -> ::ethers::contract::builders::Event<::std::sync::Arc<M>, M, StateChangedFilter>
        {
            self.0.event()
        }
    ...
    pub enum StakingErrors {
        ...
        CannotKickBelowCurrentValidatorThreshold(CannotKickBelowCurrentValidatorThreshold),
        ...
        NotEnoughTimeElapsedForTimeoutSinceLastEpoch(NotEnoughTimeElapsedForTimeoutSinceLastEpoch),
    ...
    impl ::ethers::core::abi::AbiDecode for StakingErrors {
        fn decode(
            ...
            if let Ok(decoded) =
                <ActiveValidatorsCannotLeave as ::ethers::core::abi::AbiDecode>::decode(data)
            {
                return Ok(Self::ActiveValidatorsCannotLeave(decoded));
            }
            if let Ok(decoded) = <CallerNotOwner as ::ethers::core::abi::AbiDecode>::decode(data) {
                return Ok(Self::CallerNotOwner(decoded));
            }
            if let Ok(decoded) =
                <CallerNotOwnerOrDevopsAdmin as ::ethers::core::abi::AbiDecode>::decode(data)
            {
            ...
            if let Ok(decoded) =
                <CannotReuseCommsKeys as ::ethers::core::abi::AbiDecode>::decode(data)
            {
                return Ok(Self::CannotReuseCommsKeys(decoded));
            }
            if let Ok(decoded) = <CannotStakeZero as ::ethers::core::abi::AbiDecode>::decode(data) {
                return Ok(Self::CannotStakeZero(decoded));
            }
            if let Ok(decoded) = <CannotVoteTwice as ::ethers::core::abi::AbiDecode>::decode(data) {
            ...
            if let Ok(decoded) =
                <MustBeInActiveOrUnlockedState as ::ethers::core::abi::AbiDecode>::decode(data)
            {
            ...
            if let Ok(decoded) =
                <MustBeInReadyForNextEpochState as ::ethers::core::abi::AbiDecode>::decode(data)
            {
                return Ok(Self::MustBeInReadyForNextEpochState(decoded));
            }
            if let Ok(decoded) =
                <MustBeValidatorInNextEpochToKick as ::ethers::core::abi::AbiDecode>::decode(data)
            {
            ...
            if let Ok(decoded) =
                <NotEnoughTimeElapsedSinceLastEpoch as ::ethers::core::abi::AbiDecode>::decode(data)
            {
                return Ok(Self::NotEnoughTimeElapsedSinceLastEpoch(decoded));
            }
            if let Ok(decoded) =
                <NotEnoughValidatorsInNextEpoch as ::ethers::core::abi::AbiDecode>::decode(data)
            {
            ...
            if let Ok(decoded) =
                <SignaledReadyForWrongEpochNumber as ::ethers::core::abi::AbiDecode>::decode(data)
            {
            ...
            if let Ok(decoded) =
                <TryingToWithdrawMoreThanStaked as ::ethers::core::abi::AbiDecode>::decode(data)
            {
                return Ok(Self::TryingToWithdrawMoreThanStaked(decoded));
            }
            if let Ok(decoded) =
                <ValidatorIsNotInNextEpoch as ::ethers::core::abi::AbiDecode>::decode(data)
            {
    ...
    impl ::ethers::core::abi::AbiEncode for StakingErrors {
        fn encode(self) -> ::std::vec::Vec<u8> {
            match self {
                ...
                Self::CallerNotOwner(element) => ::ethers::core::abi::AbiEncode::encode(element),
                ...
                Self::CannotStakeZero(element) => ::ethers::core::abi::AbiEncode::encode(element),
                Self::CannotVoteTwice(element) => ::ethers::core::abi::AbiEncode::encode(element),
                ...
                Self::MustBeInNextValidatorSetLockedOrReadyForNextEpochOrRestoreState(element) => {
                    ::ethers::core::abi::AbiEncode::encode(element)
                }
    ...
    impl ::core::fmt::Display for StakingErrors {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
                Self::ActiveValidatorsCannotLeave(element) => ::core::fmt::Display::fmt(element, f),
                Self::CallerNotOwner(element) => ::core::fmt::Display::fmt(element, f),
                Self::CallerNotOwnerOrDevopsAdmin(element) => ::core::fmt::Display::fmt(element, f),
                Self::CannotAddFunctionToDiamondThatAlreadyExists(element) => {
                ...
                Self::CannotReuseCommsKeys(element) => ::core::fmt::Display::fmt(element, f),
                Self::CannotStakeZero(element) => ::core::fmt::Display::fmt(element, f),
                Self::CannotVoteTwice(element) => ::core::fmt::Display::fmt(element, f),
                Self::CannotWithdrawZero(element) => ::core::fmt::Display::fmt(element, f),
                Self::CouldNotMapNodeAddressToStakerAddress(element) => {
                    ::core::fmt::Display::fmt(element, f)
                }
                ...
                Self::StakerNotPermitted(element) => ::core::fmt::Display::fmt(element, f),
                Self::TryingToWithdrawMoreThanStaked(element) => {
                    ::core::fmt::Display::fmt(element, f)
                }
                Self::ValidatorIsNotInNextEpoch(element) => ::core::fmt::Display::fmt(element, f),
    ...
    impl ::core::convert::From<CannotAddFunctionToDiamondThatAlreadyExists> for StakingErrors {
    ...
    impl ::core::convert::From<CannotKickBelowCurrentValidatorThreshold> for StakingErrors {
        fn from(value: CannotKickBelowCurrentValidatorThreshold) -> Self {
            Self::CannotKickBelowCurrentValidatorThreshold(value)
        }
    }
    impl ::core::convert::From<CannotRejoinUntilNextEpochBecauseKicked> for StakingErrors {
    ...
    impl ::core::convert::From<CannotReplaceFunctionThatDoesNotExists> for StakingErrors {
    ...
    impl ::core::convert::From<CannotReplaceFunctionsFromFacetWithZeroAddress> for StakingErrors {
    ...
    impl ::core::convert::From<MustBeInNextValidatorSetLockedOrReadyForNextEpochOrRestoreState>
        for StakingErrors
    {
        fn from(value: MustBeInNextValidatorSetLockedOrReadyForNextEpochOrRestoreState) -> Self {
    ...
    impl ::core::convert::From<NotEnoughTimeElapsedForTimeoutSinceLastEpoch> for StakingErrors {
    ...
    #[ethevent(
        ...
        abi = "RewardsDurationUpdated(uint256)"
    )]
    ...
    impl ::ethers::contract::EthLogDecode for StakingEvents {
        fn decode_log(
            ...
            if let Ok(decoded) = VotedToKickValidatorInNextEpochFilter::decode_log(log) {
                return Ok(StakingEvents::VotedToKickValidatorInNextEpochFilter(
                    decoded,
                ));
            }
    ...
    impl ::core::fmt::Display for StakingEvents {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
                Self::ClearOfflinePhaseDataFilter(element) => ::core::fmt::Display::fmt(element, f),
                Self::ComplaintConfigSetFilter(element) => ::core::fmt::Display::fmt(element, f),
                Self::ConfigSetFilter(element) => ::core::fmt::Display::fmt(element, f),
                Self::CountOfflinePhaseDataFilter(element) => ::core::fmt::Display::fmt(element, f),
                Self::DevopsAdminSetFilter(element) => ::core::fmt::Display::fmt(element, f),
                Self::DiamondCutFilter(element) => ::core::fmt::Display::fmt(element, f),
                Self::EpochEndTimeSetFilter(element) => ::core::fmt::Display::fmt(element, f),
                Self::EpochLengthSetFilter(element) => ::core::fmt::Display::fmt(element, f),
                Self::EpochTimeoutSetFilter(element) => ::core::fmt::Display::fmt(element, f),
                Self::KickPenaltyPercentSetFilter(element) => ::core::fmt::Display::fmt(element, f),
                Self::OwnershipTransferredFilter(element) => ::core::fmt::Display::fmt(element, f),
                Self::ReadyForNextEpochFilter(element) => ::core::fmt::Display::fmt(element, f),
                Self::RecoveredFilter(element) => ::core::fmt::Display::fmt(element, f),
                Self::RequestToJoinFilter(element) => ::core::fmt::Display::fmt(element, f),
                Self::RequestToLeaveFilter(element) => ::core::fmt::Display::fmt(element, f),
                ...
                Self::StakingTokenSetFilter(element) => ::core::fmt::Display::fmt(element, f),
                Self::StateChangedFilter(element) => ::core::fmt::Display::fmt(element, f),
    ...
    #[ethcall(
        ...
        abi = "lockValidatorsForNextEpoch()"
    )]
    ...
    #[ethcall(
        name = "setMaxVersion",
        abi = "setMaxVersion((uint256,uint256,uint256))"
    )]
    ...
    #[ethcall(
        name = "setMinVersion",
        abi = "setMinVersion((uint256,uint256,uint256))"
    )]
    ...
    pub enum StakingCalls {
        ...
        CountOfCurrentValidatorsReadyForNextEpoch(CountOfCurrentValidatorsReadyForNextEpochCall),
        CountOfNextValidatorsReadyForNextEpoch(CountOfNextValidatorsReadyForNextEpochCall),
        ...
        GetActiveUnkickedValidatorStructsAndCounts(GetActiveUnkickedValidatorStructsAndCountsCall),
    ...
    impl ::ethers::core::abi::AbiDecode for StakingCalls {
        fn decode(
            ...
            let data = data.as_ref();
            if let Ok(decoded) =
                <AdminKickValidatorInNextEpochCall as ::ethers::core::abi::AbiDecode>::decode(data)
            {
                return Ok(Self::AdminKickValidatorInNextEpoch(decoded));
            }
            if let Ok(decoded) =
                <AdminRejoinValidatorCall as ::ethers::core::abi::AbiDecode>::decode(data)
            {
            ...
            if let Ok(decoded) =
                <AdminSlashValidatorCall as ::ethers::core::abi::AbiDecode>::decode(data)
            {
                return Ok(Self::AdminSlashValidator(decoded));
            }
            if let Ok(decoded) =
                <AdminStakeForValidatorCall as ::ethers::core::abi::AbiDecode>::decode(data)
            {
            ...
            if let Ok(decoded) = <CheckVersionCall as ::ethers::core::abi::AbiDecode>::decode(data)
            {
            ...
            if let Ok(decoded) =
                <ContractResolverCall as ::ethers::core::abi::AbiDecode>::decode(data)
            {
            ...
            if let Ok(decoded) =
                <EmitClearOfflinePhaseDataCall as ::ethers::core::abi::AbiDecode>::decode(data)
            {
                return Ok(Self::EmitClearOfflinePhaseData(decoded));
            }
            if let Ok(decoded) =
                <EmitCountOfflinePhaseDataCall as ::ethers::core::abi::AbiDecode>::decode(data)
            {
                return Ok(Self::EmitCountOfflinePhaseData(decoded));
            }
            if let Ok(decoded) = <EpochCall as ::ethers::core::abi::AbiDecode>::decode(data) {
                return Ok(Self::Epoch(decoded));
            }
            if let Ok(decoded) = <ExitCall as ::ethers::core::abi::AbiDecode>::decode(data) {
            ...
            if let Ok(decoded) =
                <GetActiveUnkickedValidatorsCall as ::ethers::core::abi::AbiDecode>::decode(data)
            {
                return Ok(Self::GetActiveUnkickedValidators(decoded));
            }
            if let Ok(decoded) = <GetKeyTypesCall as ::ethers::core::abi::AbiDecode>::decode(data) {
                return Ok(Self::GetKeyTypes(decoded));
            }
            if let Ok(decoded) =
                <GetKickedValidatorsCall as ::ethers::core::abi::AbiDecode>::decode(data)
            {
                return Ok(Self::GetKickedValidators(decoded));
            }
            if let Ok(decoded) = <GetMaxVersionCall as ::ethers::core::abi::AbiDecode>::decode(data)
            {
                return Ok(Self::GetMaxVersion(decoded));
            }
            if let Ok(decoded) =
                <GetMaxVersionStringCall as ::ethers::core::abi::AbiDecode>::decode(data)
            {
                return Ok(Self::GetMaxVersionString(decoded));
            }
            if let Ok(decoded) = <GetMinVersionCall as ::ethers::core::abi::AbiDecode>::decode(data)
            {
                return Ok(Self::GetMinVersion(decoded));
            }
            if let Ok(decoded) =
                <GetMinVersionStringCall as ::ethers::core::abi::AbiDecode>::decode(data)
            {
                return Ok(Self::GetMinVersionString(decoded));
            }
            if let Ok(decoded) =
                <GetNodeStakerAddressMappingsCall as ::ethers::core::abi::AbiDecode>::decode(data)
            {
                return Ok(Self::GetNodeStakerAddressMappings(decoded));
            }
            if let Ok(decoded) = <GetRewardCall as ::ethers::core::abi::AbiDecode>::decode(data) {
                return Ok(Self::GetReward(decoded));
            }
            if let Ok(decoded) =
                <GetStakingBalancesAddressCall as ::ethers::core::abi::AbiDecode>::decode(data)
            {
            ...
            if let Ok(decoded) =
                <GetValidatorsInCurrentEpochCall as ::ethers::core::abi::AbiDecode>::decode(data)
            {
            ...
            if let Ok(decoded) =
                <GetValidatorsInNextEpochCall as ::ethers::core::abi::AbiDecode>::decode(data)
            {
                return Ok(Self::GetValidatorsInNextEpoch(decoded));
            }
            if let Ok(decoded) =
                <GetValidatorsStructsCall as ::ethers::core::abi::AbiDecode>::decode(data)
            {
            ...
            if let Ok(decoded) =
                <GetVotingStatusToKickValidatorCall as ::ethers::core::abi::AbiDecode>::decode(data)
            {
            ...
            if let Ok(decoded) =
                <IsActiveValidatorByNodeAddressCall as ::ethers::core::abi::AbiDecode>::decode(data)
            {
                return Ok(Self::IsActiveValidatorByNodeAddress(decoded));
            }
            if let Ok(decoded) =
                <IsReadyForNextEpochCall as ::ethers::core::abi::AbiDecode>::decode(data)
            {
                return Ok(Self::IsReadyForNextEpoch(decoded));
            }
            if let Ok(decoded) =
                <KickPenaltyPercentByReasonCall as ::ethers::core::abi::AbiDecode>::decode(data)
            {
                return Ok(Self::KickPenaltyPercentByReason(decoded));
            }
            if let Ok(decoded) =
                <KickValidatorInNextEpochCall as ::ethers::core::abi::AbiDecode>::decode(data)
            {
                return Ok(Self::KickValidatorInNextEpoch(decoded));
            }
            if let Ok(decoded) =
                <LockValidatorsForNextEpochCall as ::ethers::core::abi::AbiDecode>::decode(data)
            {
                return Ok(Self::LockValidatorsForNextEpoch(decoded));
            }
            if let Ok(decoded) =
                <NextValidatorCountForConsensusCall as ::ethers::core::abi::AbiDecode>::decode(data)
            {
                return Ok(Self::NextValidatorCountForConsensus(decoded));
            }
            if let Ok(decoded) =
                <NodeAddressToStakerAddressCall as ::ethers::core::abi::AbiDecode>::decode(data)
            {
            ...
            if let Ok(decoded) =
                <ReadyForNextEpochCall as ::ethers::core::abi::AbiDecode>::decode(data)
            {
                return Ok(Self::ReadyForNextEpoch(decoded));
            }
            if let Ok(decoded) = <RequestToJoinCall as ::ethers::core::abi::AbiDecode>::decode(data)
            {
            ...
            if let Ok(decoded) =
                <RequestToLeaveAsNodeCall as ::ethers::core::abi::AbiDecode>::decode(data)
            {
                return Ok(Self::RequestToLeaveAsNode(decoded));
            }
            if let Ok(decoded) =
                <SetComplaintConfigCall as ::ethers::core::abi::AbiDecode>::decode(data)
            {
            ...
            if let Ok(decoded) =
                <SetContractResolverCall as ::ethers::core::abi::AbiDecode>::decode(data)
            {
                return Ok(Self::SetContractResolver(decoded));
            }
            if let Ok(decoded) =
                <SetDevopsAdminCall as ::ethers::core::abi::AbiDecode>::decode(data)
            {
            ...
            if let Ok(decoded) = <SetEpochStateCall as ::ethers::core::abi::AbiDecode>::decode(data)
            {
            ...
            if let Ok(decoded) =
                <SetKickPenaltyPercentCall as ::ethers::core::abi::AbiDecode>::decode(data)
            {
                return Ok(Self::SetKickPenaltyPercent(decoded));
            }
            if let Ok(decoded) = <SetMaxVersionCall as ::ethers::core::abi::AbiDecode>::decode(data)
            {
                return Ok(Self::SetMaxVersion(decoded));
            }
            if let Ok(decoded) = <SetMinVersionCall as ::ethers::core::abi::AbiDecode>::decode(data)
            {
                return Ok(Self::SetMinVersion(decoded));
            }
            if let Ok(decoded) =
                <ShouldKickValidatorCall as ::ethers::core::abi::AbiDecode>::decode(data)
            {
                return Ok(Self::ShouldKickValidator(decoded));
            }
            if let Ok(decoded) =
                <SignalReadyForNextEpochCall as ::ethers::core::abi::AbiDecode>::decode(data)
            {
            ...
            if let Ok(decoded) = <StakeAndJoinCall as ::ethers::core::abi::AbiDecode>::decode(data)
            {
    ...
    impl ::ethers::core::abi::AbiEncode for StakingCalls {
        fn encode(self) -> Vec<u8> {
            match self {
                ...
                Self::AdminResetEpoch(element) => ::ethers::core::abi::AbiEncode::encode(element),
                ...
                Self::CheckVersion(element) => ::ethers::core::abi::AbiEncode::encode(element),
                Self::ComplaintConfig(element) => ::ethers::core::abi::AbiEncode::encode(element),
                Self::Config(element) => ::ethers::core::abi::AbiEncode::encode(element),
                Self::ContractResolver(element) => ::ethers::core::abi::AbiEncode::encode(element),
                ...
                Self::GetKeyTypes(element) => ::ethers::core::abi::AbiEncode::encode(element),
                Self::GetKickedValidators(element) => {
                    ::ethers::core::abi::AbiEncode::encode(element)
                }
                Self::GetMaxVersion(element) => ::ethers::core::abi::AbiEncode::encode(element),
                Self::GetMaxVersionString(element) => {
                    ::ethers::core::abi::AbiEncode::encode(element)
                }
                Self::GetMinVersion(element) => ::ethers::core::abi::AbiEncode::encode(element),
                ...
                Self::GetReward(element) => ::ethers::core::abi::AbiEncode::encode(element),
                ...
                Self::ReadyForNextEpoch(element) => ::ethers::core::abi::AbiEncode::encode(element),
                Self::RequestToJoin(element) => ::ethers::core::abi::AbiEncode::encode(element),
                Self::RequestToLeave(element) => ::ethers::core::abi::AbiEncode::encode(element),
                ...
                Self::SetDevopsAdmin(element) => ::ethers::core::abi::AbiEncode::encode(element),
                Self::SetEpochEndTime(element) => ::ethers::core::abi::AbiEncode::encode(element),
                Self::SetEpochLength(element) => ::ethers::core::abi::AbiEncode::encode(element),
                Self::SetEpochState(element) => ::ethers::core::abi::AbiEncode::encode(element),
                Self::SetEpochTimeout(element) => ::ethers::core::abi::AbiEncode::encode(element),
                ...
                Self::SetMaxVersion(element) => ::ethers::core::abi::AbiEncode::encode(element),
                Self::SetMinVersion(element) => ::ethers::core::abi::AbiEncode::encode(element),
                ...
                Self::StakeAndJoin(element) => ::ethers::core::abi::AbiEncode::encode(element),
    ...
    impl ::core::fmt::Display for StakingCalls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
                ...
                Self::AdminRejoinValidator(element) => ::core::fmt::Display::fmt(element, f),
                Self::AdminResetEpoch(element) => ::core::fmt::Display::fmt(element, f),
                Self::AdminSlashValidator(element) => ::core::fmt::Display::fmt(element, f),
                Self::AdminStakeForValidator(element) => ::core::fmt::Display::fmt(element, f),
                ...
                Self::EmitClearOfflinePhaseData(element) => ::core::fmt::Display::fmt(element, f),
                Self::EmitCountOfflinePhaseData(element) => ::core::fmt::Display::fmt(element, f),
                ...
                Self::GetActiveUnkickedValidators(element) => ::core::fmt::Display::fmt(element, f),
                Self::GetKeyTypes(element) => ::core::fmt::Display::fmt(element, f),
                Self::GetKickedValidators(element) => ::core::fmt::Display::fmt(element, f),
                Self::GetMaxVersion(element) => ::core::fmt::Display::fmt(element, f),
                Self::GetMaxVersionString(element) => ::core::fmt::Display::fmt(element, f),
                Self::GetMinVersion(element) => ::core::fmt::Display::fmt(element, f),
                Self::GetMinVersionString(element) => ::core::fmt::Display::fmt(element, f),
                Self::GetNodeStakerAddressMappings(element) => {
                    ::core::fmt::Display::fmt(element, f)
                }
                Self::GetReward(element) => ::core::fmt::Display::fmt(element, f),
                Self::GetStakingBalancesAddress(element) => ::core::fmt::Display::fmt(element, f),
                Self::GetTokenAddress(element) => ::core::fmt::Display::fmt(element, f),
                Self::GetValidatorsInCurrentEpoch(element) => ::core::fmt::Display::fmt(element, f),
                Self::GetValidatorsInCurrentEpochLength(element) => {
                    ::core::fmt::Display::fmt(element, f)
                }
                Self::GetValidatorsInNextEpoch(element) => ::core::fmt::Display::fmt(element, f),
                Self::GetValidatorsStructs(element) => ::core::fmt::Display::fmt(element, f),
                Self::GetValidatorsStructsInCurrentEpoch(element) => {
                    ::core::fmt::Display::fmt(element, f)
                }
                Self::GetValidatorsStructsInNextEpoch(element) => {
                ...
                Self::IsReadyForNextEpoch(element) => ::core::fmt::Display::fmt(element, f),
                Self::KickPenaltyPercentByReason(element) => ::core::fmt::Display::fmt(element, f),
                Self::KickValidatorInNextEpoch(element) => ::core::fmt::Display::fmt(element, f),
                Self::LockValidatorsForNextEpoch(element) => ::core::fmt::Display::fmt(element, f),
                Self::NextValidatorCountForConsensus(element) => {
                    ::core::fmt::Display::fmt(element, f)
                }
                Self::NodeAddressToStakerAddress(element) => ::core::fmt::Display::fmt(element, f),
                ...
                Self::RequestToLeaveAsNode(element) => ::core::fmt::Display::fmt(element, f),
                Self::SetComplaintConfig(element) => ::core::fmt::Display::fmt(element, f),
                Self::SetConfig(element) => ::core::fmt::Display::fmt(element, f),
                Self::SetContractResolver(element) => ::core::fmt::Display::fmt(element, f),
                ...
                Self::SetKickPenaltyPercent(element) => ::core::fmt::Display::fmt(element, f),
                Self::SetMaxVersion(element) => ::core::fmt::Display::fmt(element, f),
                Self::SetMinVersion(element) => ::core::fmt::Display::fmt(element, f),
                Self::ShouldKickValidator(element) => ::core::fmt::Display::fmt(element, f),
                Self::SignalReadyForNextEpoch(element) => ::core::fmt::Display::fmt(element, f),
    ...
    impl ::core::convert::From<CountOfCurrentValidatorsReadyForNextEpochCall> for StakingCalls {
        fn from(value: CountOfCurrentValidatorsReadyForNextEpochCall) -> Self {
            Self::CountOfCurrentValidatorsReadyForNextEpoch(value)
        }
    }
    impl ::core::convert::From<CountOfNextValidatorsReadyForNextEpochCall> for StakingCalls {
    ...
    impl ::core::convert::From<GetActiveUnkickedValidatorStructsAndCountsCall> for StakingCalls {
    ...
    impl ::core::convert::From<SetIpPortNodeAddressAndCommunicationPubKeysCall> for StakingCalls {
    ...
    pub struct CountOfCurrentValidatorsReadyForNextEpochReturn(pub ::ethers::core::types::U256);
    ...
    pub struct CountOfNextValidatorsReadyForNextEpochReturn(pub ::ethers::core::types::U256);
    ...
    pub struct GetKickedValidatorsReturn(pub ::std::vec::Vec<::ethers::core::types::Address>);
    ...
    pub struct GetValidatorsInNextEpochReturn(pub ::std::vec::Vec<::ethers::core::types::Address>);
    ...
    pub struct GetVotingStatusToKickValidatorReturn(pub ::ethers::core::types::U256, pub bool);
